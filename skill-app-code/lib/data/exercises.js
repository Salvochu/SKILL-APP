...
// Fetches library rows for one category with their muscle tags. Reference
// data, cached. Falls back gracefully: without the muscle join if
// migration 0017 has not run, then without the category filter if 0009
// has not run either.
...
// Reference data, identical for every user. Cached via fetchLibrary.
